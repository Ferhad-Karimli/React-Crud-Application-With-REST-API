import { Box, Button, FormGroup, Grow, IconButton,  } from "@mui/material"
...
<>
        ...
        >
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <Image src={"https://blog.sellfy.com/wp-content/uploads/2019/09/instagram-post-ideas-1200x600.png"}  height="500" cover="true" />
                <EditButton variant="contained" color="success" onClick={handleEdit}>
                        {editPost ? <SaveAsIcon/> : <EditIcon/>}
                </EditButton>
                <FormGroup>
                    <PostField edit={editPost ? "true" : ""} ref={titleRef} font="45" readOnly={!editPost} defaultValue={postState?.title}  />
                    <PostField edit={editPost ? "true" : ""} ref={bodyRef} font="25" readOnly={!editPost} defaultValue={postState?.body}  />
                </FormGroup>
                <CommentContent setCommentState={setCommentState} postId={postState?.id} comments={commentState}/>
            </Box>
        </Grow>
</>
